...
const modelList = [
    {
        name: 'MidJourney V4',
        id: 'midjourney',
        src: 'https://github.com/bfdavid33/tubepro-img-gen/blob/a88b79ef1dc92f9d103ffdf6192e17f17b6b39f1/models-pictures/midjourneyv4.png'
    },
    {
...
function initUI() {
    ...
    // Model Options
    var modelOptions1 = document.createElement('div');
    modelOptions1.style.borderRadius = '0px';
    modelOptions1.style.opacity = '1';
    modelOptions1.style.alignSelf = 'center';
    modelOptions1.style.minWidth = '50%';
    modelOptions1.style.maxWidth = '50%';
    modelOptions1.style.order = '11';
    modelOptions1.style.height = 'max-content';
    modelOptions1.style.flexGrow = '0';
    modelOptions1.style.flexShrink = '0';
    modelOptions1.style.width = '50%';
    modelOptions1.style.margin = '0px';
    modelOptions1.style.zIndex = '6';
    modelOptions1.style.display = 'block';
    modelOptions1.style.position = 'relative';
    modelOptions1.style.paddingBottom = '0px';
    modelOptions1.style.textAlign = 'center';
    for (var i = 0; i < modelList.length; i++) {
        ...
        modelImg.style.width = '110px';
        modelImg.style.height = '110px';
        ...
        modelOptions1.appendChild(modelItemContainer);
    }

    var modelOptions2 = document.createElement('div');
    modelOptions2.style.borderRadius = '0px';
    modelOptions2.style.opacity = '1';
    modelOptions2.style.alignSelf = 'center';
    modelOptions2.style.minWidth = '80%';
    modelOptions2.style.maxWidth = '80%';
    modelOptions2.style.order = '11';
    modelOptions2.style.height = 'max-content';
    modelOptions2.style.flexGrow = '0';
    modelOptions2.style.flexShrink = '0';
    modelOptions2.style.width = '80%';
    modelOptions2.style.margin = '0px';
    modelOptions2.style.zIndex = '6';
    modelOptions2.style.display = 'block';
    modelOptions2.style.position = 'relative';
    modelOptions2.style.paddingBottom = '0px';
    modelOptions2.style.textAlign = 'center';
    for (var i = 5; i < modelList.length; i++) {
        var modelItemContainer = document.createElement('div');
        modelItemContainer.style.margin = '5px';
        modelItemContainer.style.textAlign = 'center';
        modelItemContainer.style.width = 'fit-content';
        ...
        modelItemContainer.appendChild(modelImg);
        modelItemContainer.appendChild(modelLabel);
        modelOptions2.appendChild(modelItemContainer);
    }
    // Model Options
    ...
    container.appendChild(modelOptions1);
