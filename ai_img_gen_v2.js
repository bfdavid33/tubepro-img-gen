...
function getDecryptObject() {
    var leftCountItem = localStorage.getItem('83e2a745-d8b9-430b-9c0b-87cb5e72468d');
...
function setEncryptObject(leftObject) {
    ...
    localStorage.setItem("83e2a745-d8b9-430b-9c0b-87cb5e72468d", jsonString);
}
...
function addEvents() {
    ...
    generateButton.addEventListener("click", function () {
        ...
        if (dateString == decryptedObject.date) {
            leftCount = parseInt(decryptedObject.value);
            if (leftCount > 0 && prompt.value != '' && selectedHeight != '' && selectedWidth != '' && modelId != '') {
                var loadingIcon = document.getElementById("loading-icon");
