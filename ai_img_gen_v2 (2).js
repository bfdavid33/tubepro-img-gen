...
function initUI() {
    ...
    modelOptions.style.minWidth = '50%';
    modelOptions.style.maxWidth = '50%';
...
function addEvents() {
    ...
    generateButton.addEventListener("click", function () {
        ...
        if (dateString == decryptedObject.date) {
            leftCount = parseInt(decryptedObject.value);
            if (leftCount > 0 && prompt.value != '' && selectedHeight != '' && selectedWidth != '' && modelId != '' && sample != '') {
                var loadingIcon = document.getElementById("loading-icon");
