...
var stableDiffusionAPIkey = 'wKiPDq6dfHF15fLOMxlg40WnxkLXruy5PpK2HHBfR64Uv2ji0AE7luoXX6ej';

const modelList = [
    {
        name: 'MidJourney V4',
        id: 'midjourney',
        src: './models-pictures/midjourneyv4.png'
    },
    {
        name: 'Realistic Vision V1.3',
        id: 'realistic-vision-v13',
        src: './models-pictures/realistic-vision-v13.png'
    },
    {
        name: 'GTA5 Artwork Diffusion',
        id: 'gta5-artwork-diffusi',
        src: './models-pictures/gta5.png'
    },
    {
        name: 'Dream Shaper',
        id: 'dream-shaper-8797',
        src: './models-pictures/dream-shaper.png'
    },
    {
        name: 'SynthwavePunk',
        id: 'synthwave-diffusion',
        src: './models-pictures/synthwave-punk.png'
    },
    {
        name: 'drood_lyriel_v15',
        id: 'droodlyrielv15',
        src: './models-pictures/drood-lyriel.jpeg'
    },
    {
        name: 'Redshift Diffusion',
        id: 'redshift-diffusion',
        src: './models-pictures/redshift-diffusion.png'
    },
    {
        name: 'Disco Diffusion',
        id: 'disco-diffusion',
        src: './models-pictures/disco-diffusion.jpeg'
    },
    {
        name: 'Low Poly World',
        id: 'lowpoly-diffusion',
        src: './models-pictures/lowpoly-diffusion.png'
    },
    {
        name: 'Midjourney-v4-PaintArt',
        id: 'midjourney-v4-painta',
        src: './models-pictures/midjourney-v4-painta.png'
    },
]
...
function initUI() {
    ...
    // Upscale Elements
    var upscaleSelectionContainer = document.createElement('div');
    var upscaleLabelContainer = document.createElement('div');
    var upscaleLabel = document.createElement('div');
    upscaleLabel.innerHTML = 'Upscale: ';
    var upscaleOptions = document.createElement('div');

    upscaleSelectionContainer.style.justifyContent = 'flex-start';
    upscaleSelectionContainer.style.borderRadius = '0px';
    upscaleSelectionContainer.style.opacity = '1';
    upscaleSelectionContainer.style.alignSelf = 'center';
    upscaleSelectionContainer.style.minWidth = '80%';
    upscaleSelectionContainer.style.maxWidth = '80%';
    upscaleSelectionContainer.style.order = '12';
    upscaleSelectionContainer.style.minHeight = '30px';
    upscaleSelectionContainer.style.height = 'max-content';
    upscaleSelectionContainer.style.flexGrow = '0';
    upscaleSelectionContainer.style.flexShrink = '0';
    upscaleSelectionContainer.style.width = '80%';
    upscaleSelectionContainer.style.margin = '10px 0px 0px 0px';
    upscaleSelectionContainer.style.zIndex = '9';
    upscaleSelectionContainer.style.flexDirection = 'row';
    upscaleSelectionContainer.style.flexWrap = 'wrap';
    upscaleSelectionContainer.style.display = 'flex';
    upscaleSelectionContainer.style.alignContent = 'stretch';

    upscaleLabelContainer.style.whiteSpace = 'pre-wrap';
    upscaleLabelContainer.style.overflow = 'visible';
    upscaleLabelContainer.style.fontFamily = 'Open Sans, sans-serif';
    upscaleLabelContainer.style.fontSize = '14px';
    upscaleLabelContainer.style.fontWeight = 'bold';
    upscaleLabelContainer.style.color = 'rgba(77,79,79,1)';
    upscaleLabelContainer.style.lineHeight = '1.4';
    upscaleLabelContainer.style.borderRadius = '0px';
    upscaleLabelContainer.style.opacity = '1';
    upscaleLabelContainer.style.alignSelf = 'flex-start';
    upscaleLabelContainer.style.minWidth = '60px';
    upscaleLabelContainer.style.order = '3';
    upscaleLabelContainer.style.minHeight = '27px';
    upscaleLabelContainer.style.width = 'max-content';
    upscaleLabelContainer.style.flexGrow = '0';
    upscaleLabelContainer.style.height = 'max-content';
    upscaleLabelContainer.style.margin = '0px';
    upscaleLabelContainer.style.zIndex = '8';
    upscaleLabelContainer.style.display = 'flex';
    upscaleLabelContainer.style.flexDirection = 'column';
    upscaleLabelContainer.style.justifyContent = 'center';
    upscaleLabelContainer.appendChild(upscaleLabel);

    upscaleOptions.style.alignSelf = 'flex-start';
    upscaleOptions.style.minWidth = '50px';
    upscaleOptions.style.order = '7';
    upscaleOptions.style.minHeight = '40px';
    upscaleOptions.style.width = 'max-content';
    upscaleOptions.style.flexGrow = '0';
    upscaleOptions.style.height = 'max-content';
    upscaleOptions.style.margin = '0px 0px 0px';
    upscaleOptions.style.zIndex = '12';
    upscaleOptions.style.gridTemplateColumns = 'repeat(1, 1fr)';
    upscaleOptions.style.fontFamily = 'Open Sans, sans-serif';
    upscaleOptions.style.fontSize = '14px';
    upscaleOptions.style.fontWeight = '400';
    upscaleOptions.style.color = 'rgb(79, 76, 247)';
    upscaleOptions.style.opacity = '1';
    upscaleOptions.style.position = 'relative';
    upscaleOptions.style.paddingTop = '0px';
    upscaleOptions.style.paddingBottom = '0px';
    upscaleOptions.style.display = 'flex';
    upscaleOptions.style.gridAutoRows = 'max-content';
    upscaleOptions.style.paddingLeft = '20px';
    upscaleOptions.style.gap = '0px 20px';
    upscaleOptions.classList.add('size-radio-container');
    upscaleOptions.classList.add('upscale-radio-container');

    const upscaleOptionList = ['Yes', 'No'];

    upscaleOptionList.map((option, index) => {
        var upscaleOption = document.createElement('input');
        var upscaleOptionLabel = document.createElement('label');
        var optionContainer = document.createElement('div');
        upscaleOption.setAttribute('type', 'radio');
        upscaleOption.setAttribute('name', 'ai_image_upscale');
        upscaleOption.setAttribute('id', `ai_image_upscale_option_${index}`);
        upscaleOption.setAttribute('value', `${option}`);

        upscaleOptionLabel.style.display = 'inline-block';
        upscaleOptionLabel.style.verticalAlign = 'middle';
        upscaleOptionLabel.style.position = 'relative';
        upscaleOptionLabel.style.paddingLeft = '6px';
        upscaleOptionLabel.style.paddingRight = '6px';
        upscaleOptionLabel.style.cursor = 'pointer';
        upscaleOptionLabel.style.width = '100%';
        upscaleOptionLabel.style.minWidth = '25px';
        upscaleOptionLabel.style.marginTop = '3px';
        upscaleOptionLabel.style.fontFamily = 'Open Sans, sans-serif';
        upscaleOptionLabel.setAttribute('for', `ai_image_upscale_option_${index}`);
        upscaleOptionLabel.innerHTML = option;
        optionContainer.style.display = 'flex';
        optionContainer.style.alignItems = 'center';
        optionContainer.style.height = '25px';
        optionContainer.style.height = '25px';
        optionContainer.style.paddingTop = '4px';
        optionContainer.style.paddingBottom = '4px';
        optionContainer.appendChild(upscaleOption);
        optionContainer.appendChild(upscaleOptionLabel);
        upscaleOptions.appendChild(optionContainer);
    })

    upscaleSelectionContainer.appendChild(upscaleLabelContainer);
    upscaleSelectionContainer.appendChild(upscaleOptions);
    ...
    limitationElement.style.fontSize = '17px';
    limitationElement.style.fontWeight = '400';
    limitationElement.style.color = '#2c2c2d';
    ...
    for (var i = 0; i < modelList.length; i++) {
        ...
        modelItemContainer.style.margin = '5px';
        ...
        modelImg.style.width = '180px';
        modelImg.style.height = '180px';
    ...
    container.appendChild(upscaleSelectionContainer);
...
function completeGeneration(resultObject) {
    ...
    for (var i = 0; i < resultObject.output.length; i++) {
        var imgObject = document.getElementById(`result_img_${i}`);
...
function addEvents() {
    ...
    generateButton.addEventListener("click", function () {
        ...
        var selectedHeight = '', selectedWidth = '', upscale = '';
        var modelId = '';
        ...
        var upscaleOption = document.getElementsByName("ai_image_upscale");
        for (var i = 0; i < upscaleOption.length; i++) {
            if (upscaleOption[i].checked) {
                upscale = upscaleOption[i].value.toLowerCase();
                console.log("Selected Upscale: " + upscale);
                break;
            }
        }
        ...
        if (prompt.value != '' && selectedHeight != '' && selectedWidth != '' && modelId != '' && upscale != '') {
            var loadingIcon = document.getElementById("loading-icon");
            ...
            if (upscale == '') {
                message += message != '' ? '\nPlease select upscale' : 'Please select upscale';
            }
...
function addStyle() {
    ...
    // Get all the radio buttons inside the container
    var upscaleRadioButtons = document.querySelectorAll('.upscale-radio-container input[type="radio"]');

    // Loop through each radio button
    for (var i = 0; i < upscaleRadioButtons.length; i++) {
        upscaleRadioButtons[i].addEventListener('change', function() {
            // Remove the "selected" class from all labels
            var labels = document.querySelectorAll('label');
            for (var j = 0; j < labels.length; j++) {
                labels[j].classList.remove('selected');
